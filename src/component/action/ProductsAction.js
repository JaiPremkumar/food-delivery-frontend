...
export const getProducts = async(dispatch)=>{
    try {
        ...
        const {data} = await axios.get(`https://food-delivery-3-urm7.onrender.com/api/v1/products`) 
...
export const searchProducts = name=> async(dispatch)=>{
    try {
        ...
        const {data} = await axios.get(`https://food-delivery-3-urm7.onrender.com/api/v1/search?keyword=${name}`) 
...
export const searchcatProducts = categroies=> async(dispatch)=>{
    try {
        ...
        const {data} = await axios.get(`https://food-delivery-3-urm7.onrender.com/api/v1/category?keys=${categroies}`) 
...
export const resProducts = seller=> async(dispatch)=>{  
    try {
        ...
        const {data} = await axios.get(`https://food-delivery-3-urm7.onrender.com/api/v1/seller?keys=${seller}`) 
