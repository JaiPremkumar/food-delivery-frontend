...
export const login =(email,password)=>async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`https://backend-food-delivery-3aba.onrender.com/api/v1/login`,{email,password})
...
export const register =(formData)=>async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`https://backend-food-delivery-3aba.onrender.com/api/v1/register`,formData,config)
...
export const loadUser =async (dispatch) => {
    try {
        ...
        const {data} = await axios.get(`https://backend-food-delivery-3aba.onrender.com/api/v1/myDp`) 
...
export const logOut =async (dispatch) => {
    try {
         ...
         await axios.post(`https://backend-food-delivery-3aba.onrender.com/api/v1/logout`)
...
export const updateProfile =(name,email)=>async (dispatch) => {
    try {
        ...
        const {data} = await axios.put(`https://backend-food-delivery-3aba.onrender.com/api/v1/updateuser`,{name,email})
